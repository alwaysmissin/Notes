...
![](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20221207114903.png)
![](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20221207120719.png)
...
- 结论（a、b为不全为0的常数）：
	...
	- 设二维随机变量$(X,Y)\sim N(\mu_1,\mu_2,\sigma_1^2,\sigma_2^2,\rho)$，则aX+bY服从正态分布![](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20221207163904.png)
	...
	- #概率论重点 设随机变量$X$与$Y$相互独立，$X$的密度函数为$f_X(x)$，分布函数为$F_X(x)$；$Y$的密度函数为$f_Y(y)$，分布函数为$F_Y(y)$$$M= \max \left\{ X,Y \right\} ,N= \min \left\{ X,Y\right\}$$则$M$与$N$的分布函数与密度函数分别为：$$\begin{array}{c}F_M(x)=F_X(x)F_Y(y) \\ f_M(x)=F_M^\prime(x)=f_X(x)F_Y(x)+F_X(x)f_Y(x) \\ F_N(x)=1-[1-F_X(x)][1-F_Y(x)] \\ f_N(x)=F_N^\prime(x)=f_X(x)[1-F_Y(x)]+f_Y(x)[1-F_X(x)]\end{array}$$![](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20221212101526.png)![](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20221212101545.png)
## 常见的二维连续性随机变量的分布
### 二维正态分布
...
![](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20221212142939.png)
![](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20221212142947.png)
