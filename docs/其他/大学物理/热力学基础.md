...
- 准静态做功的计算
	...
	- 系统所做的功再树枝上等于P-V图上过程曲线以下的面积![](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20221113231012.png)
### 热力学第一定律
...
- 摩尔定压热容：$C_{p,m}=\frac{(dQ)_p}{\frac{m}{M}dT}=C_{V,m}+R=\frac{i+2}{2}R$
	...
	- ![](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20221114230852.png)
