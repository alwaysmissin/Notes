...
- 例子：同位数相除：![](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20221212211617.png)
### 拓展指令
- `CBW`、`CWD`功能：将符号位进行**拓展**
	- `CBW`：$AL\rightarrow AX$
	- `CWD`：$AX\rightarrow (DX,AX)$
![](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20221212211747.png)
## 逻辑运算和移位指令
### 逻辑运算指令
#### AND
...
![](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20221212212543.png)
### 移位指令
- 分类：
	- 逻辑：SHL/SHR![](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20221212212649.png)
	- 算数：SAL/SAR![](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20221212212658.png)
	- 循环：ROL/ROR![](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20221212212706.png)
	- 带进位循环：RCL/RCR![](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20221212212715.png)
- 共同特点：
	- 都是按位进行
	- 当移动的位数为一位时，用立即数1
	- 当移动二维以上时，要预先将移动的位数存放在`CL`中
		- `SHL AL, 2`$\rightarrow$`MOV CL, 2; SHL AL, CL;`
- 32位数据的移动方式：![](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20221212212909.png)
## 控制转移指令
### 无条件转移指令
- 格式：`JMP 地址表达式`
...
#### 标志位条件转移指令
[[8086指令系统#状态标志|状态标志]]
![](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20221212214452.png)
#### 两个无符号数比较转移指令
![](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20221212223940.png)
#### 两个有符号数比较转移指令
![](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20221212223954.png)
...
- 格式：`JCXZ 标号`
- 功能：当`CX=0`时，转向标号
![](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20221213125116.png)
### 子程序调用和返回指令
#### CALL过程调用
- 格式：CALL 子程序/地址表达式
- 功能：
...
- 调用方式与跳转指令类似：![](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20221213125403.png)![](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20221213125410.png)
#### RET子程序返回指令
- 格式：`RET [n]`
