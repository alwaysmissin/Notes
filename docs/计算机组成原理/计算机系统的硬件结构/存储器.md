...
### 数据的存储和排列顺序
- 想要知道如何取出内存中存放的一个数据，需要知道这个数据在内存中是如何存放的：![image.png](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20230314190009.png)
	- 大端方式：数据低位在高地址
	- 小端方式：数据低位在低地址
...
![image.png](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20230314190333.png)
...
## 半导体存储芯片简介
### 半导体存储芯片的基本结构
![image.png](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20230314191246.png)
- 存储芯片的基本结构：
...
> 片选线的作用：
> - 由于集成芯片容量有限，想要组成一个大的存储器一般需要将多个芯片连接使用。如想要使用$16K\times 1位$的存储芯片组成$64K\times 8位$的存储器，需要按照如下方式组成一个存储器：![image.png](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20230314192218.png)
> - 当芯片的片选信号($\bar{CS}$)有效时，芯片才被选中，才能对其进行读写操作

### 地址译码器的设计
- 线选法：地址译码器只有一个，用一根字线直接选中一个存储单元的各个位![image.png](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20230314192603.png)
	- 缺点：当地址线数量较大，**译码器复杂**、开销大，使存储器成本迅速增加
- 重合法：使用两个译码器（X地址译码器，Y地址译码器）来选择一个地址![image.png](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20230314192614.png)

## 随机存取寄存器(Random Access Memory)
### SRAM
![image.png](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20230314193740.png)
#### 六静态MOS管电路
![image.png](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20230314194130.png)
> 信息存储的原理：可以将其看诶是一个带时钟的RS触发器
- 写入时：
...
- SRAM基本电路的读操作：![SRAM读数据.gif](https://raw.githubusercontent.com/alwaysmissin/picgo/main/SRAM%E8%AF%BB%E6%95%B0%E6%8D%AE.gif)
- SRAM基本电路的写操作：![SRAM写数据.gif](https://raw.githubusercontent.com/alwaysmissin/picgo/main/SRAM%E5%86%99%E6%95%B0%E6%8D%AE.gif)
...
- 三管MOS动态RAM基本单元电路：![image.png](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20230314201912.png)
	- 特点：
		- 读出的信息与原信息相反
		- 写入与输入的信息相同
- 单管MOS动态RAM基本单元电路：![image.png](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20230314202456.png)
	- 构造：
		- 信息记忆在**记忆电容**$C_S$中
		- T为门控管，控制数据的进出
			- 栅极接读写选择线（字线）
...
- 读时序：![image.png](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20230314203724.png)
- 写时序：![image.png](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20230314203735.png)
...
- 三种刷新方式：
	- 集中刷新：前一段时间正常读写，后一段时间停止读写，集中逐行刷新
		- 集中刷新时间长，无法进行正常的读写操作（死区）![image.png](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20230314210411.png)
	- 分散刷新：一个存储周期分为两段，前一段用于正常读写操作，后一段用于刷新操作
		- 不存在死区，但每个存储周期加长![image.png](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20230314213417.png)
	- **异步刷新**：结合了集中刷新和分散刷新。![image.png](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20230314213427.png)
...
### 几种ROM类型
- 掩膜ROM(MROM)![image.png](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20230316200712.png)
	- 以元件的有无表示1/0
...
- PROM（Programmable ROM）![image.png](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20230316202939.png)
	- 允许用户利用专门的设备写入自己的程序，一旦写入后，其内容无法改变
		- 熔丝断——0，熔丝未断——1![image.png](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20230316202851.png)
> PROM有两种结构，一种是熔丝烧断型，另外一种是PN结击穿型
- EPROM（Erasable Programmable ROM）
	- 目前使用较多的是由浮动栅雪崩注入型MOS管构成
	- 可以由用户利用编程器写入信息，可以多次改写
	- 浮栅晶体管：![300](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20230316203858.png)
		- 写入：![300](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20230316203613.png)
		- 读0：![300](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20230316203735.png)
			- 浮栅层中没有电子
		- 读1：![300](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20230316204106.png)
		- 破坏：![image.png](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20230316204137.png)
	- 分类：
...
- 三种拓展方式：
	...
	- 字拓展：增加存储字数量![P30320-220021.jpg](https://raw.githubusercontent.com/alwaysmissin/picgo/main/P30320-220021.jpg)
	- 字位同时拓展：![image.png](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20230320221038.png)
- 存储器与CPU的连接
	- 地址线的连接：内部地址线、芯片选择线
	...
	- 其他：时序、负载
- 例题4.1：
	1. 主存地址分配：![image.png](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20230320222312.png)
		- 根据地址范围写出二进制代码，再进行划分操作
	2. 选取存储芯片：根据已有芯片，进行选择
	3. 画出存储芯片的片选逻辑图![例题4-1.gif](https://raw.githubusercontent.com/alwaysmissin/picgo/main/%E4%BE%8B%E9%A2%984-1.gif)
		- 分配地址线
		- 确定片选信号
> 地址线上的信号需要做到物尽其用
- 例题4.2
	1. 主存地址分配：![image.png](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20230323131021.png)
	2. 存储芯片选择：![image.png](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20230323131043.png)
	3. 画图：![image.png](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20230323131056.png)
## 存储器的校验
...
- 高位交叉：![image.png](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20230323133407.png)
...
- 低位交叉：![image.png](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20230323133427.png)
...
> [!对于低位交叉的一些讨论]
> 如果联想到总线中的总线通信控制中的分离式控制，我们可以很好的利用空闲时间，在取前一个存储体数据时，后一个存储体可以同时在准备数据，提高效率![image.png](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20230323134059.png)
...
- 存储器控制部件![image.png](https://raw.githubusercontent.com/alwaysmissin/picgo/main/20230323134253.png)
